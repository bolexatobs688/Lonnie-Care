...
const Header = () => {
  ...
  const linkClass = ({ isActive }) =>
    isActive
      ? "text-[#4789A3] font-semibold border-l-4 border-[#4789A3] pl-4 transition-all"
      : "text-white hover:text-[#4789A3] pl-4 transition-colors duration-200";
      ...
      {menuOpen && (
        <div className="fixed top-0 right-0 h-full w-[60%] max-w-xs bg-[#2d2d2d] z-50 shadow-lg flex flex-col">
          ...
          <div className="flex justify-between items-center p-6 border-b border-gray-700">
            ...
            <button className="text-white text-2xl" onClick={() => setMenuOpen(false)}>×</button>
          </div>
